//  TERHUBUNG DENGAN API OMDB

const search = document.getElementById("search-btn");
// const see_detail = document.querySelectorAll(".card .card-body .see-detail");
// const movie_list = document.getElementById("movie-list");w
      ...
      .then(function (data) {
        ...
        <div class="card" style="width: 18rem; margin:10px;">
          ...
          <div class="card-body">
            ...
            <a href="#" class="see-detail" data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-id="${movie.imID}">See Detail</a>
          </div>
        </div>`;
        });
      })
...
// movie_list.addEventListener("click" , function(){
//   console.log("anda memencet se detail")
// })